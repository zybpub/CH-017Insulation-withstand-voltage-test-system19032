...
/*
   ...
   helper.LogHelper.LogFlag = true; //开启记录
   helper.LogHelper.LogInfo("==========日志记录内容 Info====");
   helper.LogHelper.LogWarn("==========日志记录内容 Warn====");
   helper.LogHelper.LogError("==========日志记录内容 Error====");
   helper.LogHelper.LogFlag = false;//停止记录     Tools.Log.LogHelper.ExitThread();// 退出日志记录线程，一般在程序退出时候调用。
